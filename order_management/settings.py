...
SECRET_KEY = 'django-insecure-x4*gmsu_!)9$skb(!3_pm^il2@c&!!-*k1x7&44e)0ksos^%mc'
...
LOGIN_REDIRECT_URL = '/'
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'create_order'  # Redirect to order form after login
LOGOUT_REDIRECT_URL = 'login'  # Redirect to login form after logout
